...
A RESTful API for tracking personal expenses with user authentication, CRUD operations, and a responsive SPA frontend. Built with FastAPI, SQLAlchemy, and JWT authentication.
...
```bash
git clone https://github.com/Najo24-code/expense-tracker-api.git
