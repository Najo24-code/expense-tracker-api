# De Control De Gastos Personales

![CI](https://github.com/Najo24-code/de-control-de-gastos-personales/workflows/CI/badge.svg)
...
```bash
# Clonar
git clone https://github.com/Najo24-code/de-control-de-gastos-personales.git
cd de-control-de-gastos-personales
...
```bash
# Build
docker build -t de-control-de-gastos-personales .

# Run
docker run -p 8000:8000 de-control-de-gastos-personales
```
